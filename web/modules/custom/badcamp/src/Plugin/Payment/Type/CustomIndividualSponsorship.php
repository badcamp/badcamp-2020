 ...
 *
 * @PaymentType(
 *   id = "custom_badcamp_payment_sponsorship",
 *   label = @Translation("Custom Individual Sponsorship"),
 * )
 */
class CustomIndividualSponsorship extends PaymentTypeBase {
  ...
  public function getPaymentDescription() {
    return $this->t('Custom Individual Sponsorship');
  }
